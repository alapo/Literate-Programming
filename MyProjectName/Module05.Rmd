...
pacman::p_load(tidyverse, report, googlesheets4, janitor, knitr, remotes, rstatix, ggpubr, ggstatsplot, jtools, sjPlot, sjmisc, parameters) # load/install required packages
...
# Load/Install required packages ---------------------
if (!require("pacman")) install.packages("pacman") # if pacman is not installed, the install it.
pacman::p_load(tidyverse, report, googlesheets4, effectsize, see, janitor, remotes, rstatix, ggpubr, ggstatsplot, jtools, sjPlot, sjmisc, parameters) # load/install required packages
