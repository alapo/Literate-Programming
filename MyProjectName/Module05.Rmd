...
pacman::p_load(effectsize, ggpubr, ggstatsplot, googlesheets4, janitor, jtools, knitr, parameters, remotes, report, rstatix, tidyverse,  see, sjPlot, sjmisc) # load/install required packages
